...
$(document).ready(function () {
  $.ajax({
    type: "GET",
    url: "http://localhost:5050/farm/api/v1/vehicles/allVehicles",
    headers: {
...
$("#saveBtn").on("click", function (event) {
  ...
  $.ajax({
    url: "http://localhost:5050/farm/api/v1/staff",
    method: "POST",
...
function searchStaff() {
  ...
  $.ajax({
    ...
    url: `http://localhost:5050/farm/api/v1/staff?searchTerm=${searchTerm}`,
    success: function (data) {
...
$("#updateBtn").on("click", function (event) {
  ...
  $.ajax({
    url: `http://localhost:5050/farm/api/v1/staff/${staffId}`,
    method: "PUT",
    contentType: "application/json",
    data: JSON.stringify(staffData),
    headers: {
