...
function loadCrops() {
  fetch("http://localhost:5050/farm/api/v1/crops/allcrops", {
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
    },
  })
...
$("#monitoringLogForm").on("submit", function (e) {
  ...
  $.ajax({
    url: "http://localhost:5050/farm/api/v1/monitoringLog",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false,
...
function searchAndFillLogForm() {
  ...
  $.ajax({
    url: `http://localhost:5050/farm/api/v1/monitoringLog?searchTerm=${encodeURIComponent(searchTerm)}`,
    type: "GET",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("token")}`,
    },
...
$("#updateBtn").on("click", function () {
    ...
    $.ajax({
      url: `http://localhost:5050/farm/api/v1/monitoringLog/${logCode}`,
      type: "PUT",
      data: formData,
      contentType: false,
      processData: false,
