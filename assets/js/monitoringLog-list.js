$(document).ready(function () {
  ...
  function fetchFields() {
    return fetch(
      "http://localhost:5050/farm/api/v1/fields/allFields",
      {
        headers: {
  ...
  function fetchCrops() {
    return fetch("http://localhost:5050/farm/api/v1/crops/allcrops", {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
    })
  ...
  function fetchAndDisplayMonitoringLogs() {
    fetch("http://localhost:5050/farm/api/v1/monitoringLog/allLogs", {
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
    })
  ...
  $("#backBtn").click(function () {
    window.location.href = "/page/monitoringLog.html";
  });
});
